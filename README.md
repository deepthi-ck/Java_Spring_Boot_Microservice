...
Spring Boot **microservices** for **Java 21 only**.
...
implemented as a **Maven multi-module** reactor for Java 21 with integrated quality tools
...
├── docker-compose.yml
├── pom.xml                 Parent reactor (Java 21 + tools)
└── mvnw / mvnw.cmd
```
