...
Spring Boot **microservices** for **Java 17 only**.
...
implemented as a **Maven multi-module** reactor for Java 17 with integrated quality tools
(not a copy of that Gradle/Zuul stack).
...
├── docker-compose.yml
├── pom.xml                 Parent reactor (Java 17 + tools)
└── mvnw / mvnw.cmd
```
