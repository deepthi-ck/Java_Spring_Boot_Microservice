...
Spring Boot **microservices** for **Java 8 only**.
...
implemented as a **Maven multi-module** reactor for Java 8 with integrated quality tools
...
├── docker-compose.yml
├── pom.xml                 Parent reactor (Java 8 + tools)
└── mvnw / mvnw.cmd
```
