...
Spring Boot **microservices** for **Java 25 only**.
...
implemented as a **Maven multi-module** reactor for Java 25 with integrated quality tools
...
├── docker-compose.yml
├── pom.xml                 Parent reactor (Java 25 + tools)
└── mvnw / mvnw.cmd
```
