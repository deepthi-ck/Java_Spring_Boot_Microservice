...
Java 11 Spring Boot microservices (Scenario: multi-service), inspired by common Eureka + Gateway layouts
(such as [nihadamirov/spring-boot-microservices](https://github.com/nihadamirov/spring-boot-microservices))
while remaining a Maven multi-module project tailored for Java 11 + integrated quality tools.
