...
Java 8 Spring Boot microservices (Scenario: multi-service), inspired by common Eureka + Gateway layouts
(such as [nihadamirov/spring-boot-microservices](https://github.com/nihadamirov/spring-boot-microservices))
while remaining a Maven multi-module project tailored for Java 8 + integrated quality tools.
