...
Java 25 Spring Boot microservices (Scenario: multi-service), inspired by common Eureka + Gateway layouts
(such as [nihadamirov/spring-boot-microservices](https://github.com/nihadamirov/spring-boot-microservices))
while remaining a Maven multi-module project tailored for Java 25 + integrated quality tools.

Stack: Spring Boot **3.5.x** + Spring Cloud **2025.0.x** on the `jakarta.*` namespace.
